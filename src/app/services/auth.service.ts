...
import { SignInRequest } from 'src/app/models/auth/sign-in-request.interface';
import { SignUpRequest } from 'src/app/models/auth/sign-up-request.interface';
...
export class AuthService {
  private apiUrl = 'http://localhost:3000/api/auth' // auth와 확인 필요 

  constructor(private http:HttpClient) { }

  signUp(signUpRequest:SignUpRequest): Observable<ApiResponse<void>>{
    return this.http.post<ApiResponse<void>>(`${this.apiUrl}/signup`, signUpRequest);
  }
